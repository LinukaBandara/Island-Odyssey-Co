...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    desc: "A fortress rising from a granite outcrop fifteen centuries ago, still standing above the forest plains it was built to watch.",
    img: "/images/dambulla.jpg",
    thumb: "/images/dambulla-thumb.jpg",
    alt: "Sigiriya rock fortress rising above the forest canopy in Sri Lanka",
    tag: "culture",
...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    highlights: ["Sunrise climb up Sigiriya rock", "Ancient frescoes and mirror wall", "Temple of the Tooth ceremony, Kandy"],
    tag: "culture",
  },
];
